...
$req = $bdd->query("SELECT * FROM question2");
...
<div class="d-flex justify-content-center">
    <img src="img/php-logo.jpg" height="200px" alt="logo">
</div>
<br>
<br>
<div class="container d-flex justify-content-around">
    <form method="post">
        ...
        while ($question = $req->fetch()) {
            $answer = $bdd->query("SELECT * FROM choices2 WHERE choices2.question_nb = " . $question["question_nb"]);
            ?>
            ...
            <label>
                ...
                while ($reponse = $answer->fetch()) {
                    echo "<input type='checkbox'>" . $reponse['text'] . "<br>";
                }
                ?>
            </label>
            <br>
